...
def generate_video(prompt, image, fire=False, water=False, fun=False, dance=False, debug=False):
    ...
    try:
        ...
        DANCE_PROMPT = "all  people and objects burst into dynamic, playful dance movements. Animate each element to groove with unique, whimsical dance styles, trees sway rhythmically like they’re in a breeze, and objects like cars or furniture bounce and spin with cartoonish energy. Add vibrant effects like glowing neon trails following their movements, sparkling confetti bursting around them, and colorful light pulses syncing to the beat. Use dynamic camera angles: zoom in on a person’s smooth dance moves, pan across objects twirling in unison, and pull back to reveal a joyful, dance-filled world. Infuse a fun, atmosphere, creating a laugh-out-loud, high-energy spectacle where everything dances in a dazzling, rhythmic celebration."
        extras = []
        if fire:
